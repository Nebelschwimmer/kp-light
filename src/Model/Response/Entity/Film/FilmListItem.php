...
class FilmListItem
{
  public function __construct(?int $id = null, ?string $name, ?string $directorName, ?string $preview, array $genres, int $releaseYear, float $rating, ?string $description = null) 
  {
    $this->id = $id;
    $this->name = $name;
