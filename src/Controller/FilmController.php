...
class FilmController extends AbstractController
{
  ...
  public function addActor(
    int $id,
    #[MapRequestPayload] ?ActorDto $dto,
  ): Response {
    $data = null;
    $actorId = $dto->actorId;
    $status = Response::HTTP_OK;
    try {
      $data = $this->filmService->addActor($id, $actorId);
    } catch (\Throwable $e) {
  ...
  /**
   * Delete actor from a film
   */
  #[Route(path: '/api/films/{id}/actors',
    name: 'api_film_actor_delete',
    methods: ['DELETE'],
  )
  ]
  #[OA\Response(
  ...
  public function deleteActor(
    ...
    try {
      ...
      $data = $this->filmService->deleteActor($id, $actorId);
    } catch (\Throwable $e) {
      $this->logger->error($e);
      $data = $e->getMessage();
      $status = Response::HTTP_INTERNAL_SERVER_ERROR;
  ...
  /**
   * Add director to a film
   */
  #[Route(path: '/api/films/{id}/director',
    name: 'api_film_director_add',
    methods: ['POST'],
  )
  ]
  #[OA\Response(
  ...
  public function addDirector(
    int $id,
    #[MapRequestPayload] ?DirectorDto $dto,
  ): Response {
    $data = null;
    $directorId = $dto->directorId;
    $status = Response::HTTP_OK;
    try {
      $data = $this->filmService->addDirector($id, $directorId);
    } catch (\Throwable $e) {
      $this->logger->error($e);
      $data = $e->getMessage();
      $status = Response::HTTP_INTERNAL_SERVER_ERROR;
